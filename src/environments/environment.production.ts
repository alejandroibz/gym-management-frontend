export const environment = {
  ...
  studentAppUrl: 'https://alejandroibz.github.io/gym-management-student',
  auth0: {
    ...
    redirectUri: 'https://admin.simbiosisgym.com.ar',
    logoutReturnTo: 'https://admin.simbiosisgym.com.ar'
  }
};
